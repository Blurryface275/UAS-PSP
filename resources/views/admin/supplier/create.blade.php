...
@section('content')
<h1 class="mt-4">Tambah Supplier Baru</h1>
<div class="card mb-4 border-0 shadow-sm" style="max-width: 650px;">
    <div class="card-header bg-white"><i class="fas fa-plus-circle me-1 text-primary"></i> Form Pendaftaran Supplier</div>
    <div class="card-body">
        ...
        <form action="{{ route('supplier.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                       value="{{ old('name') }}" placeholder="Contoh: PT. Maju Bersama" required>
